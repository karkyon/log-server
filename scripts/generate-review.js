...
function renderScript(fids, allLogs, allShots, issuesData, allSeqs) {
  ...
  '  if(id.indexOf("flow_")===0){ var _fid=id.slice(5); setTimeout(function(){if(window.initFlowPage)initFlowPage(_fid);},50); }',
    ...
    '      \'</div></div>\';',
    '  });',
    '  var sep=\'<div style="flex:1 1 0;min-width:20px;display:flex;align-items:center;">\'+',
    ...
    '    var rowDir="";',
    '    html+=\'<div style="display:flex;align-items:center;gap:0;flex-wrap:nowrap;justify-content:space-between;">\'+chunk.join(sep)+\'</div>\';',
    '    if(!isLast){',
    '      var xc=containerW-60;',
    '      var sw=3,arr=8,lh=28;',
    '      html+=\'<div style="height:44px;width:100%;position:relative;">\'+',
